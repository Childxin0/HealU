"use strict";
const EMOTION_SEMANTIC_RULES = [
  {
    id: "grief-death-missing",
    describe: "丧亲、宠物离世、悼念与想念",
    test: (t) => /去世|离世|过世|悼念|毛孩子|宠物去世|宠物离开|狗去世|猫去世|永别|阴阳两隔|丧礼|哀思/.test(t) || /想念.{0,16}(奶奶|爷爷|外公|外婆|姥爷|姥姥)/.test(t) || /(奶奶|爷爷|外公|外婆|姥爷|姥姥).{0,12}(去世|走了|离开|不在)/.test(t),
...
exports.EMOTION_SEMANTIC_RULES = EMOTION_SEMANTIC_RULES;
exports.PATTERN_MULTIPLIERS = PATTERN_MULTIPLIERS;
